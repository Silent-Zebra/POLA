...
For the plots (Figures 4 and 5), the workflow is to run the commands, then paste the checkpoint names into the result_plots.py file (in the code, now in the jax_files folder).  Figures 2 and 3 were generated by hand using the output from the commands. Figure 1 
