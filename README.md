...
For the plots (Figures 3 and 4), the workflow is to run the commands, then paste the checkpoint names into the result_plots.py file (in the code, now in the jax_files folder). Figures 1 and 2 were generated by hand using the output from the commands.
